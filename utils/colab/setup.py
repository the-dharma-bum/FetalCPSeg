...
DATASET_URL = 'https://mega.nz/#!tFNGkLQS!mpq8s6gK2SH6xJOBeYsw62yQlZAN9of4_nHnMjQjfMQ'
...
def get_data():
    ...
    subprocess.check_call(['/content/FetalCPSeg/utils/colab/download.sh', DATASET_URL])
